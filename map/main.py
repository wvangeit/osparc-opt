...
class ParamCreator:
    def __init__(self):
        ...
        self.map_output_path = self.main_outputs_dir / "output_2" / "objs.json"
    ...
    def check_engine_files(self):
        ...
        for input_dir in self.input_dirs:
            ...
            if engine_fn.exists():
                ...
                if (
                    engine_info["status"] == "ready"
                    and not self.engine_submitted[engine_info["id"]]
                ):
    ...
    def set_engine_ready(self, engine_id):
        ...
        master_dict["engines"][engine_id] = {"task": {"command": "get ready"}}
